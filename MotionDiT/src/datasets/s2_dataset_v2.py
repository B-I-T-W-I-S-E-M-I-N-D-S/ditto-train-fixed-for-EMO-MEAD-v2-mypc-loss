...
class Stage2Dataset(Dataset):
    def __init__(
            ...
            use_emo2vec=False,   # Emotion2vec continuous audio emotion features (MEMO)
            mtn_mean_var_npy="",
    ...
    def _load_one(self, data):
        ...
        if self.use_emo2vec:
            emo2vec = np.load(data['emo2vec'])[:frame_num]   # [n, 1024]
            arr_data['emo2vec'] = emo2vec
    ...
    def getitem(self, idx):
        ...
        if self.use_emo2vec:
            v_emo2vec = arr_data['emo2vec']
            emo2vec_seq = v_emo2vec[f_idx: f_idx + seq_len]   # [n, 1024]
            data_dict['emo2vec_cond'] = emo2vec_seq
