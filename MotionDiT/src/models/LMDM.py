...
class LMDM:
    def __init__(
        ...
        diffusion = MotionDiffusion(
            ...
            dim_ws=dim_ws,
            # ── emotion auxiliary losses ────────────
            use_emotion_losses=use_emotion_losses,
            lambda_emo_cls=lambda_emo_cls,
            lambda_emo_perc=lambda_emo_perc,
            lambda_emo_contrast=lambda_emo_contrast,
            lambda_emo_temporal=lambda_emo_temporal,
        )
